...
<%
    // Obtener la matrícula o identificador del administrador desde la sesión
    String matriculaSesion = (String) session.getAttribute("matriculaAdmin");
%>
...
<div class="container">
    <div class="form text-center d-flex justify-content-center align-items-center ">
        <div class="text-center">
            <form action="cambiarContraAdmin" class="form border-0 text-center" method="post">
                <img src="../IMG2/login.png" alt="profile icon" class="profile-icon" width="174px">
                <input type="hidden" name="matriculaAdmin" value="<%= matriculaSesion != null ? matriculaSesion : "" %>" />
