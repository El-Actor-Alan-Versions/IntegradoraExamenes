...
public class GmailSender {
    ...
    private static final String FROM = "examenessistema@gmail.com";
    private final Gmail service;
    public GmailSender() throws Exception {
        NetHttpTransport httpTransport = GoogleNetHttpTransport.newTrustedTransport();
        GsonFactory jsonFactory = GsonFactory.getDefaultInstance();
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory))
                .setApplicationName("Examenes")
                .build();
    }
    ...
    public static void main(String[] args) throws Exception {
        new GmailSender().sendMail("dericklagunes@utez.edu.mx","A new message",
                "<h1>Alan Mondragon Quintanar, Juan Esquivel Castillo, Brando Miranda Mendez, Salem Roman Jimenez, Edwin Yair Garcia Guadarrama</h1>");
    }
